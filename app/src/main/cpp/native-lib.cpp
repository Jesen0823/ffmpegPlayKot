...
Java_com_jesen_code_ffmpegplaykot_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jstring JNICALL
Java_com_jesen_code_ffmpegplaykot_util_FUtils_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_jesen_code_ffmpegplaykot_util_FUtils_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_jesen_code_ffmpegplaykot_util_FUtils_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_jesen_code_ffmpegplaykot_util_FUtils_avFilterInfo(JNIEnv *env, jobject type) {
    char info[40000] = {0};
...
Java_com_jesen_code_ffmpegplaykot_util_FUtils_playVideo(JNIEnv *env, jclass type,
                                                         jstring videoPath_,
                                                         jobject surface) {
    ...
    ALOGI("open input result is: %d",ret);
    if (ret != 0) {
